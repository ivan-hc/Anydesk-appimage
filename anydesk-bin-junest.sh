...
rm -R -f ./$APP.AppDir/.junest/usr/lib/libcrypt*
rm -R -f ./$APP.AppDir/.junest/usr/lib/libdb-*
rm -R -f ./$APP.AppDir/.junest/usr/lib/libdb.*
rm -R -f ./$APP.AppDir/.junest/usr/lib/libdb_*
...
rm -R -f ./$APP.AppDir/.junest/usr/lib/libicudata.so*
...
rm -R -f ./$APP.AppDir/.junest/usr/lib/libicuuc.so*
...
rm -R -f ./$APP.AppDir/.junest/usr/lib/libpython*
rm -R -f ./$APP.AppDir/.junest/usr/lib/librsvg-2.so*
...
mv ./*AppImage ./AnyDesk_"$VERSIONAUR"-x86_64.AppImage
